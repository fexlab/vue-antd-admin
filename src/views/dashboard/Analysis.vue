<template>
  <div>
    <a-row style="margin: 0 -12px">
      <a-col :sm="24" :md="12" :xl="6" style="padding: 0 12px 24px;">
      ...
      <a-col :sm="24" :md="12" :xl="6" style="padding: 0 12px 24px;">
        <chart-card title="运营活动效果" total="73%">
          ...
          <div slot="footer">
            <trend style="margin-right: 16px" term="周同比" :percent="12" :is-increase="true" :scale="0" />
            <trend term="日同比" :target="100" :value="89" :scale="0" />
          </div>
        </chart-card>
      </a-col>
    </a-row>
